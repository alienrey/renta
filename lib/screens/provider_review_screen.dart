      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            leading: IconButton(
              icon: Icon(Icons.arrow_back, color: appData.isDark ? whiteColor : blackColor),
              onPressed: () {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ClipRRect(borderRadius: BorderRadius.circular(5), child: Image.asset(painter1, fit: BoxFit.cover)),
                      ),
                      Space(8),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("John Smith", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30)),
                          SmoothStarRating(
                  ...
                  Space(16),
                  Text("Date And Time", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 20)),
                  Space(4),
                  Text(
                    "26 jan 2022 at 4am",
                  ...
                  Space(16),
                  Text("Detail Review", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 20)),
                  Text(
